		...
		public void Main_PreDraw()
		{
			try{
				...
				if((this.gui_size.w != NRender2D.Render2D.GetInstance().GetGuiW())||(this.gui_size.h != NRender2D.Render2D.GetInstance().GetGuiH())){
					...
					NRender2D.Render2D.GetInstance().GuiScreenToVirtualScreen(0,0,out t_x1,out t_y1);
					NRender2D.Render2D.GetInstance().GuiScreenToVirtualScreen(this.gui_size.w,this.gui_size.h,out t_x2,out t_y2);
