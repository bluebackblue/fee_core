...
{
	/** ConvertSheet_TexturePrefab
	*/
	#if(UNITY_EDITOR)
	public class ConvertSheet_TexturePrefab
	{
		/** COMMAND
		*/
		public const string COMMAND = "<textureprefab>";

		/** リストアイテム。
		*/
		public class ListItem
		{
			/** textureprefab_command
			*/
			public string textureprefab_command;

			/** textureprefab_tag
			*/
			public string textureprefab_tag;

			/** textureprefab_assetspath
			*/
			public string textureprefab_assetspath;
		}
